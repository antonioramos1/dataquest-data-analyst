...
/home/dq/random_numbers$ git config --global user.name pepon

## 6. Committing Changes ##

/home/dq/random_numbers$ git commit -m "Inital commit. Added script.py and READM
...
/home/dq/random_numbers$ git commit -m "script.py updated to generate randomints
