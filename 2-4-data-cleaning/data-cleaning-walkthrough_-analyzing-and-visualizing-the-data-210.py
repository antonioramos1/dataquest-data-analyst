...
m.scatter(x=longitudes, y=latitudes, s=20, zorder=2, latlon=True, cmap='summer', c=combined['ell_percent'])

## 11. Calculating District-Level Statistics ##

import numpy as np

districts = pd.groupby(combined, combined['school_dist']).agg(np.mean)
