...
def prob_combination(k,N):
    combi = (p**k) * (q**(N-k))
    return combination(k,N) * combi

prob_8 = prob_combination(8,10)
prob_9 = prob_combination(9,10)
prob_10 = prob_combination(10,10)

print(combination(8,10))