...
content = requests.get("http://api.open-notify.org/iss-pass.json", params=parameters2).content
...
in_space_count = requests.get('http://api.open-notify.org/astros.json').json()['number']